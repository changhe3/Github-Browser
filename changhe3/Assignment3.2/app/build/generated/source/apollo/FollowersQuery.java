...
public final class FollowersQuery implements Query<FollowersQuery.Data, FollowersQuery.Data, FollowersQuery.Variables> {
  public static final String OPERATION_DEFINITION = "query Followers($login: String!, $first: Int!, $after: String) {\n"
      + "  user(login: $login) {\n"
      + "    __typename\n"
  ...
  public FollowersQuery(@Nonnull String login, int first, @Nullable String after) {
    Utils.checkNotNull(login, "login == null");
    variables = new FollowersQuery.Variables(login, first, after);
  }

  @Override
  public String operationId() {
    return "1d2e4140fd4a0614b1283f1cdbf5b9a4b4ee03d8ddb3e0143ee22a57245a5fad";
  }
  ...
  public static final class Builder {
    ...
    public FollowersQuery build() {
      Utils.checkNotNull(login, "login == null");
      return new FollowersQuery(login, first, after);
    }
  }
  ...
  public static class User {
    static final ResponseField[] $responseFields = {
      ...
      ResponseField.forObject("followers", "followers", new UnmodifiableMapBuilder<String, Object>(2)
    ...
    public User(@Nonnull String __typename, @Nonnull Followers followers) {
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          ...
          writer.writeObject($responseFields[1], followers.marshaller());
        }
      };
    }
    ...
    public static final class Mapper implements ResponseFieldMapper<User> {
      ...
      public User map(ResponseReader reader) {
        ...
        final Followers followers = reader.readObject($responseFields[1], new ResponseReader.ObjectReader<Followers>() {
          @Override
          public Followers read(ResponseReader reader) {
            return followersFieldMapper.map(reader);
          }
        });
        return new User(__typename, followers);
      }
    }
  }
  ...
  public static class Followers {
    ...
    public Followers(@Nonnull String __typename, @Nonnull PageInfo pageInfo,
    ...
    public static final class Mapper implements ResponseFieldMapper<Followers> {
      ...
      public Followers map(ResponseReader reader) {
        ...
        return new Followers(__typename, pageInfo, nodes);
      }
    }
  }
